...
#define GEN_MEM2REG_EXTRACT_DEFS(isInt, ordinal, valueType)                                             \
  ...
  , typename std::conditional<((isInt) && (ordinal) == 5), valueType, uint64_t>::type __mem2reg_i5    \
  ...
  , typename std::conditional<(!(isInt) && (ordinal) == 2), valueType, double>::type __mem2reg_d2     \
  , typename std::conditional<(!(isInt) && (ordinal) == 3), valueType, double>::type __mem2reg_d3     
...
#define GEN_MEM2REG_EXTRACT_TYPES(isInt, ordinal, valueType)                                \
  ...
  , typename std::conditional<((isInt) && (ordinal) == 5), valueType, uint64_t>::type     \
  ...
  , typename std::conditional<(!(isInt) && (ordinal) == 2), valueType, double>::type      \
  , typename std::conditional<(!(isInt) && (ordinal) == 3), valueType, double>::type
