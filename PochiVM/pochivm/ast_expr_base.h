...
public:
    ...
    const char* ToString() const
    {
        ...
        case AstNodeType::AstIncrIfEqStatement: return "AstIncrIfEqStatement";
        case AstNodeType::AstIncrStatement: return "AstIncrStatement";
        ...
        case AstNodeType::AstGotoStmt: return "AstGotoStmt";
        case AstNodeType::AstLabelStmt: return "AstLabelStmt";
